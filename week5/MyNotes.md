...
it's because A has a larger distance to Q than to the possibleMinDist from C to Q  
in which case C will examine both subtrees, but actually, the possibleMinDist could not  
be the vertical differences between the y-coord since 
...
C  &nbps;|    
       &nbps;|    Q      
      A|  
the minimum can only be the dist((xA,yC),Q)
...
The following files were submitted:
----------------------------------
 18K Oct 14 06:21 KdTree.java
3.7K Oct 14 06:21 PointSET.java
...
Inserting n points into a PointSET
               ...
               n      ops per second
----------------------------------------
=> passed   160000    1373887         
=> passed   320000    1551774         
=> passed   640000    1202884         
=> passed  1280000    1008226         
==> 4/4 tests passed
...
Performing contains() queries after inserting n points into a PointSET
               ...
               n      ops per second
----------------------------------------
=> passed   160000    1022043         
=> passed   320000     784569         
=> passed   640000     703492         
=> passed  1280000     648343         
==> 4/4 tests passed
...
Test 1a-d: Insert n points into a 2d tree. The table gives the average number of calls
           to methods in RectHV and Point per call to insert().
               ...
               n      ops per second       RectHV()           x()               y()             equals()
----------------------------------------------------------------------------------------------------------------
=> passed   160000    1824846               0.0              33.9              32.7               0.0         
=> passed   320000    2039253               0.0              35.5              33.2               0.0         
=> passed   640000    1566039               0.0              38.4              36.0               0.0         
=> passed  1280000    1184099               0.0              39.5              39.3               0.0         
==> 4/4 tests passed
...
Test 2a-h: Perform contains() queries after inserting n points into a 2d tree. The table gives
           the average number of calls to methods in RectHV and Point per call to contains().
               ...
               n      ops per second       x()               y()               equals()
-----------------------------------------------------------------------------------------------
=> passed    10000    1346228              18.5              17.5               0.0         
=> passed    20000    1360446              19.7              18.7               0.0         
=> passed    40000    1304976              21.8              20.8               0.0         
=> passed    80000    1241577              22.0              21.0               0.0         
=> passed   160000    1127370              23.2              22.2               0.0         
=> passed   320000     806945              25.0              24.0               0.0         
=> passed   640000     689542              25.7              24.7               0.0         
=> passed  1280000     763288              27.2              26.2               0.0         
==> 8/8 tests passed
...
Test 3a-h: Perform range() queries after inserting n points into a 2d tree. The table gives
           the average number of calls to methods in RectHV and Point per call to range().
               ...
               n      ops per second       intersects()      contains()        x()               y()
---------------------------------------------------------------------------------------------------------------
=> passed    10000     591517               0.0              31.1              64.9              26.2         
=> passed    20000     634160               0.0              32.6              68.5              31.4         
=> passed    40000     533584               0.0              39.3              82.0              32.3         
=> passed    80000     573716               0.0              40.7              84.8              33.8         
=> passed   160000     442701               0.0              42.5              90.9              40.7         
=> passed   320000     479610               0.0              40.2              84.3              34.6         
=> passed   640000     284185               0.0              43.3              91.1              39.7         
=> passed  1280000     317898               0.0              47.0              97.8              36.0         
==> 8/8 tests passed
...
Test 4a-h: Perform nearest() queries after inserting n points into a 2d tree. The table gives
           the average number of calls to methods in RectHV and Point per call to nearest().
               ...
               n      ops per second     distanceSquaredTo()     distanceSquaredTo()        x()               y()
------------------------------------------------------------------------------------------------------------------------
=> passed    10000   420773                  41.6                   24.8                   107.9             107.1         
=> passed    20000   434721                  45.9                   27.2                   118.1             117.4         
=> passed    40000   311849                  53.9                   31.9                   139.4             137.5         
=> passed    80000   285233                  55.3                   32.5                   140.6             140.7         
=> passed   160000   312899                  60.0                   35.2                   153.2             152.7         
=> passed   320000   300593                  62.8                   36.7                   159.4             158.0         
=> passed   640000   269137                  64.9                   38.1                   164.9             164.3         
=> passed  1280000   190739                  72.8                   42.5                   184.0             183.0         
==> 8/8 tests passed
